...
const BODY_VIEWBOX = '0 0 900 648';
...
// Forearms take a half set on every pull, curl, shrug and RDL; that rule lives
// in these defaults so machine and free-weight versions are treated alike.
...
const PATTERN_MUSCLES = {
  ...
  HINGE:         { HAMSTRINGS:1, LOWER_BACK:1, GLUTES:0.5, FOREARMS:0.5 },
  ...
  HORIZ_PULL:    { UPPER_BACK:1, LATS:0.5, BICEPS:0.5, REAR_DELT:0.5, FOREARMS:0.5 },
  VERT_PULL:     { LATS:1, BICEPS:0.5, UPPER_BACK:0.5, FOREARMS:0.5 },
  TRAPS:         { TRAPS:1, FOREARMS:0.5 },
  SIDE_DELT:     { SIDE_DELT:1 },
  REAR_DELT:     { REAR_DELT:1, UPPER_BACK:0.5 },
  TRI_OH:        { TRICEPS:1 },
  TRI_PUSHDOWN:  { TRICEPS:1 },
  BICEPS:        { BICEPS:1, FOREARMS:0.5 },
...
const EXERCISE_MUSCLES = {
  ...
  ROW_PENDLAY:  { UPPER_BACK:1, LATS:0.5, BICEPS:0.5, REAR_DELT:0.5, FOREARMS:0.5, LOWER_BACK:0.5 },
  ROW_INVERTED: { UPPER_BACK:1, LATS:0.5, BICEPS:0.5, REAR_DELT:0.5, FOREARMS:0.5 },
  PULLOVER_DB:  { LATS:1, CHEST:0.5, TRICEPS:0.5, FOREARMS:0.5 },
  SHRUG_KELSO:  { TRAPS:1, UPPER_BACK:0.5, FOREARMS:0.5 },
  CUBAN_PRESS:  { SIDE_DELT:1, REAR_DELT:0.5, FRONT_DELT:0.5 },
  FACE_PULL_CABLE: { REAR_DELT:1, UPPER_BACK:0.5, TRAPS:0.5 },
  SKULLCRUSHER_BB: { TRICEPS:1, FOREARMS:0.5 },
    ...
    <div className="mt-6 border border-stone-200 rounded-xl overflow-hidden bg-white">
      <div className="px-4 py-3 border-b border-stone-200 bg-stone-50">
        ...
        <div className="text-xs text-stone-500 mt-0.5">
          Sets per week. Compound lifts give a half set to each supporting muscle.
          {' '}{trained} of {ORDER.length} muscles at 3 or more sets.
        </div>
      </div>
      ...
      <div className="px-4 pb-4 text-xs text-stone-500 leading-relaxed">
        Below 3 sets a week a muscle stays grey. Colour deepens to 15 sets.
        Hatched segments come from optional workouts.
      </div>
    </div>
  );
}
